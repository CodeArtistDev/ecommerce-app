...
const Login = ({ setToken }) => {
  ...
  return (
    <div className='flex items-center justify-center w-full min-h-screen '>
        <div className='bg-white shadow-md rounded-lg px-8 max-w-md h-100 flex flex-col items-start justify-center pb-10'>
           ...
           <form onSubmit={onSubmitHandler}>
                ...
                <button className='mt-10 w-full py-2 px-4 rounded-md text-white bg-black' type='submit'>Login</button>
           </form>
        </div>
    </div>
  )
