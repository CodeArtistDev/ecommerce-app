...
const Collection = () => {
  const { products, showSearch, search } = useShop();
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap:10 pt-10 border-t border-gray-300'>
      ...
      <div className='min-w-60'>
        <p onClick={() => setShowFilter(!showFilter)} className='my-2 text-xl flex items-center cursor-pointer gap-2'>FILTERS <img className={`h-3 sm:hidden ${showFilter ? ' rotate-90' : ''}`} src={assets.dropdown_icon} alt="filter-expand-icon" /></p>
